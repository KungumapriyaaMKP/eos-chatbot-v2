/**
 * Nineteenth dataset pass -- one regression introduced by v18's new
 * get_upcoming_events intent: "upcoming campus hiring events" (a
 * placement-drive question, "hiring events" being a common alternate
 * phrasing for a recruitment drive) was bleeding toward the new intent
 * purely off the shared word "events". Anchors the hiring-specific
 * phrasing back onto get_upcoming_drives, which already handles this
 * exact real-world question.
 *
 * Usage: npx tsx scripts/rebuild-dataset-v19.ts
 */
...
const NEW_EXAMPLES: Record<string, string[]> = {
  get_upcoming_drives: [
    'upcoming campus hiring events',
    'any hiring events coming up',
