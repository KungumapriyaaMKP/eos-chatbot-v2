/**
 * Sixth dataset augmentation pass — follow-up to augment-dataset-5.ts.
 * "marks of ganesh" / "marsk of ganesh" pushed the general "marks of
 * <name>" pattern into range, but the specific heavy-typo combination
 * found live ("shw me marsk of vignesh" — typo'd verb AND typo'd keyword
 * AND a name the anchor examples hadn't seen) still landed at 0.513,
 * just under the 0.55 threshold — every one of its 6 nearest neighbours
 * was still get_marks/marks-adjacent, just not close enough. Anchoring
 * the "shw me marsk of ..." shape directly, rather than adding more names
 * one at a time, is what actually generalizes.
 *
 * Usage: npx tsx scripts/augment-dataset-6.ts
 */
...
const NEW_EXAMPLES: Record<string, string[]> = {
  get_marks: ['shw me marsk of a student', 'shw marsk for a student by name', 'shw me marsk of ganesh'],
};
