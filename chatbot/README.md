...
User question
   ...
   → cosine similarity against 2,871 trained examples across 97 intents
...
2. Embeds all 2,871 example utterances with SBERT into `src/embeddings/embeddings.json`.
...
The classifier is trained on **97 intents / 2,871 examples** as of the
latest dataset pass (`scripts/rebuild-dataset-v17.ts`) — held-out accuracy on
