...
User question
   ...
   → cosine similarity against 2,557 trained examples across 95 intents
...
2. Embeds all 2,557 example utterances with SBERT into `src/embeddings/embeddings.json`.
...
The classifier is trained on **95 intents / 2,557 examples** as of the
