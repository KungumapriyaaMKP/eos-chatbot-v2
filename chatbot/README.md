...
User question
   ...
   → cosine similarity against 2,771 trained examples across 97 intents
...
2. Embeds all 2,771 example utterances with SBERT into `src/embeddings/embeddings.json`.
...
The classifier is trained on **97 intents / 2,771 examples** as of the
latest dataset pass (`scripts/rebuild-dataset-v15.ts`) — held-out accuracy on
a freshly-composed 1,000-question benchmark is **85.9%+ (876+/1,020)**, up
